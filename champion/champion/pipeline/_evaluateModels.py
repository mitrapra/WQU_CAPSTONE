...
if __name__ == "__main__":
    ...
    log_model.model_evaluation()  # Evaluate the Logistic Regression model
    log_model.backtest_strategy()  # Backtest the strategy for the Logistic Regression model

    arima_model = ARIMA()
    arima_model.model_evaluation()  # Evaluate the ARIMA model
    arima_model.backtest_strategy()  # Backtest the strategy for the ARIMA model

    rf_model = RandomForest()
    rf_model.model_evaluation()  # Evaluate the Random Forest model
    rf_model.backtest_strategy()  # Backtest the strategy for the Random Forest model

    lightgbm_model = LightGBM()
    lightgbm_model.model_evaluation()  # Evaluate the LightGBM model
    lightgbm_model.backtest_strategy()  # Backtest the strategy for the LightGBM model

    xgboost_model = XGBoost()
    xgboost_model.model_evaluation()  # Evaluate the XGBoost model
    xgboost_model.backtest_strategy()  # Backtest the strategy for the XGBoost model

    ann_model = ANN()
    ann_model.model_evaluation()  # Evaluate the ANN model
    ann_model.backtest_strategy()  # Backtest the strategy for the ANN model

    lstm_model = LongShortTM()
    lstm_model.model_evaluation()  # Evaluate the LSTM model
    lstm_model.backtest_strategy()  # Backtest the strategy for the LSTM model

    ensemble_voting_model = Ensemble_Voting()
    ensemble_voting_model.model_evaluation()  # Evaluate the Ensemble Voting model
    ensemble_voting_model.backtest_strategy()  # Backtest the strategy for the Ensemble Voting model

    ensemble_stacking_model = Ensemble_Stacking()
    ensemble_stacking_model.model_evaluation()  # Evaluate the Ensemble Stacking model
    ensemble_stacking_model.backtest_strategy()  # Backtest the strategy for the Ensemble Stacking model
