...
class Ensemble_Voting(_mainModeling):
    """A class for training and evaluating a Voting Classifier ensemble model."""

    def __init__(self):
        """Initialize the Ensemble_Voting class."""
        super().__init__()
    ...
    def get_estimators(self) -> list:
        """Get base estimators for the Voting Classifier."""
        all_estimators = []
